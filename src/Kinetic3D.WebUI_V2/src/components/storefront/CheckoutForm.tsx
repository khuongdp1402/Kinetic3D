      ...
      <form onSubmit={handleSubmit} className="space-y-6 flex-1 flex flex-col">
        ...
        <div className="mt-auto pt-6 border-t border-neutral-800">
          ...
          <button
            ...
            className="w-full bg-[#fb923c] text-black font-bold uppercase tracking-widest py-4 rounded hover:bg-[#ff7a45] transition-colors shadow-[0_0_15px_rgba(255,95,31,0.3)] disabled:opacity-50 disabled:cursor-not-allowed"
          >
